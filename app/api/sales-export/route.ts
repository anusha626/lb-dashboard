...
const getCachedRows = unstable_cache(computeSalesRows, ["sales-export-current-v7"], { revalidate: 300 });
const getCachedRowsPast = unstable_cache(computeSalesRows, ["sales-export-past-v7"], { revalidate: 43200 });
