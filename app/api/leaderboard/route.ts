...
import { fetchOrders, getSalesperson, getOrderBranch, isPaidOrder } from "@/lib/easystore";
...
const getCachedLeaderboard = unstable_cache(computeLeaderboard, ["leaderboard-v5-current"], { revalidate: 300 });
const getCachedLeaderboardPast = unstable_cache(computeLeaderboard, ["leaderboard-v5-past"], { revalidate: 43200 });
