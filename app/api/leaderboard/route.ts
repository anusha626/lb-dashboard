...
const getCachedLeaderboard = unstable_cache(computeLeaderboard, ["leaderboard-current"], { revalidate: 300 });
const getCachedLeaderboardPast = unstable_cache(computeLeaderboard, ["leaderboard-past"], { revalidate: 43200 });
